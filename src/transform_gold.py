...
df = pd.read_parquet('data/silver/weather_silver.parquet')
...
df.to_parquet('data/gold/weather_gold.parquet', index=False)

# print(df[['city', 'forecast_date', 'risk_score', 'risk_level']].head(10))